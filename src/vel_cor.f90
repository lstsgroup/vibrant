...
!***********************************************************************************
    ...
    SUBROUTINE cvv_resraman(framecount, natom, alpha_resraman_x_diff_re, alpha_resraman_y_diff_re, &
...
!!!ISOTROPIC!!!
  ...
  !!IM*RE (SUBTRACT)
                ...
                norm_iso(0:t1 - t0, k) = norm_iso(0:t1 - t0, k) + 1
            END DO
        END DO
...
!!!ANISOTROPIC!!!
  ...
  !!IM*RE (SUBTRACT)
                ...
                norm_aniso(0:t1 - t0, k) = norm_aniso(0:t1 - t0, k) + 1
            END DO
        END DO
