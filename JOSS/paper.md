...
In this work, we present Vibrant, a vibrational analysis program written in Fortran 2008 with interfaces to the FFTW [@frigo1998fftw] and GreenX (GX-AC) [@leucke2025analytic] libraries and parallelized using OpenMP for computational efficiency. Vibrant enables the generation of vibrational spectra for gases, liquids and in particular materials through post-processing atomic positions, velocities, forces, dipole moments and polarizability tensors. Its functionalities include the computation of both static and molecular dynamics (MD)-based infrared (IR) and  Raman spectra, as well as frequency analyses such as normal mode analysis and power spectrum calculations. In addition, Vibrant enables the computation of resonance Raman (RR) and absorption spectra based on real-time propagation trajectories. Vibrant is distributed under the Apache 2.0 license and is available as open-source software on GitHub.
