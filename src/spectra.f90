...
!....................................................................................................................!
    ...
    SUBROUTINE spec_abs(gs, sys, rams)
        ...
        !
        !REAL(kind=dp), DIMENSION(:, :, :, :, :, :), ALLOCATABLE, INTENT(INOUT) :: rams%pol_rtp
        !COMPLEX(kind=dp), DIMENSION(:, :, :, :, :, :), ALLOCATABLE, INTENT(OUT)            :: rams%zhat_pol_rtp
        ...
        IF (rams%check_pade=='y') THEN

            ALLOCATE (y_out(sys%natom, dims, dir, 3, 3, rams%framecount_rtp_pade))
        !!Call Pade
        ...
        END DO
        CLOSE (13)
        DEALLOCATE (rams%pol_rtp, trace, abs_intens)
...
!REAL(kind=dp), DIMENSION(:, :, :), ALLOCATABLE, INTENT(INOUT)       :: stats%disp
!COMPLEX(kind=dp), DIMENSION(:, :, :, :, :, :), ALLOCATABLE, INTENT(INOUT)            :: rams%zhat_pol_rtp
...
!!!Finite differences
        zhat_pol_dxyz_rtp(:, :, :, :, :) = REAL((REAL(rams%zhat_pol_rtp(:, :, 2, :, :, :), kind=dp) &
                                                 - REAL(rams%zhat_pol_rtp(:, :, 1, :, :, :), kind=dp))*factor, kind=dp)
...
!!!Broadening the spectrum!!
        ...
        DEALLOCATE (rams%zhat_pol_rtp, zhat_pol_dxyz_rtp, zhat_pol_dq_rtp)
