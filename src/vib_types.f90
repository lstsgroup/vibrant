MODULE vib_types
    ...
    CONTAINS
        PROCEDURE, NOPASS :: init_rr_static_dip   ! initializes static_dip*_rtp
...
CONTAINS
    ...
    SUBROUTINE init_rr_static_dip(arr, natoms, nframes)
        !CLASS(resonant_raman), INTENT(INOUT), OPTIONAL :: this
    ...
    SUBROUTINE deallocate_types(sys, md, stats, ram, dip)
