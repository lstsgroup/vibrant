MODULE vib_types
    ...
    PUBLIC :: global_settings, systems, molecular_dynamics, static, dipoles, raman, static_property, deallocate_types
    ...
    !***************************************************************************
    ! Type for Fragments of a System
    TYPE fragments
        INTEGER                                             :: nfrag
    ...
    !***************************************************************************
    ! Type for handeling electric field Types
    TYPE electric_field
    ...
    TYPE resonant_raman
        ...
        COMPLEX(kind=dp), DIMENSION(:, :, :, :, :, :), ALLOCATABLE :: zhat_pol_rtp ! Adjust to Static Type?
...
CONTAINS
    ...
    SUBROUTINE deallocate_raman(rams)
        ...
        ! Deallocating electric field Property
        DO xyz = 1, 3
        ...
        ! Deallocating Resonant Raman Property
