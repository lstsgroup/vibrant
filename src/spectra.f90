...
!        !REAL(kind=dp), INTENT(INOUT)                               :: md%dt, md%dom
!        !REAL(kind=dp), INTENT(IN)                                  ::md%freq_range
!        !REAL(kind=dp), INTENT(OUT)                                 :: sys%mass_tot
...
!        !REAL(kind=dp), DIMENSION(:, :, :), ALLOCATABLE, INTENT(INOUT)  :: md%coord_v, md%v
