MODULE setup
    ...
    PUBLIC :: read_input, masses_charges, conversion, pbc_orthorombic, pbc_hexagonal, pbc_orthorombic_old !constants,
...
!!*********************************************************************************************
    ...
    SUBROUTINE conversion(dt, freq_range, dt_rtp, freq_range_rtp)

        REAL(kind=dp), INTENT(OUT)              :: freq_range, freq_range_rtp
...
!********************************************************************************************
    ...
    SUBROUTINE pbc_orthorombic_old(coord2, coord1, vec, vec_pbc, box_x, box_y, box_z)

        REAL(kind=dp), DIMENSION(3), INTENT(INOUT)                :: vec, vec_pbc, coord2, coord1
        REAL(kind=dp), INTENT(IN)                                :: box_x, box_y, box_z
